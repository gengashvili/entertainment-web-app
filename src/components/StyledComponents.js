...
export const BookMarkIcon = styled.div`
  ...
  background-image: url(${({isBookmarked})=>isBookmarked?fullBookmark:emptyBookmark});
  background-size: 40%;
...
export function PlayBtn({show,trending}) {
  return (
    <StyledPlayBtn show={show} trending={trending}><img src={playImg} alt=''/>Play</StyledPlayBtn>
  )
}
